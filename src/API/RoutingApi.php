...
class RoutingApi
{
     ...
     * @return \GraphHopper\Model\RouteResponse
     */
     ...
     * @throws \GraphHopper\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GraphHopper\Model\RouteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\GraphHopper\Model\RouteResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\GraphHopper\Model\RouteResponse',
