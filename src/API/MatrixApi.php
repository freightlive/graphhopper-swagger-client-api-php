...
class MatrixApi
{
     ...
     * @return \GraphHopper\Model\MatrixResponse
     */
     ...
     * @throws \GraphHopper\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GraphHopper\Model\MatrixResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function matrixGetWithHttpInfo($key, $point = null, $from_point = null, $to_point = null, $out_array = null, $vehicle = 'car')
    {
        $returnType = '\GraphHopper\Model\MatrixResponse';
     ...
     *
     * @param  string $key Get your key at graphhopper.com (required)
     * @param  \GraphHopper\Model\MatrixRequest $body body (optional)
     *
     * @throws \GraphHopper\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GraphHopper\Model\MatrixResponse
     ...
     *
     * @param  string $key Get your key at graphhopper.com (required)
     * @param  \GraphHopper\Model\MatrixRequest $body (optional)
     *
     * @throws \GraphHopper\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GraphHopper\Model\MatrixResponse, HTTP status code, HTTP response headers (array of strings)
