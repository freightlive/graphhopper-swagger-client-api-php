...
class VrpApi
{
     ...
     */
    public function postVrpAsync($key, $body)
    {
        return $this->postVrpAsyncWithHttpInfo($key, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postVrpAsyncWithHttpInfo
     *
     * Solves vehicle routing problems
     *
     * @param  string $key your API key (required)
     ...
     */
    protected function postVrpRequest($key, $body)
    {
        // verify the required parameter 'key' is set
        if ($key === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $key when calling postVrp'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postVrp'
            );
        }
