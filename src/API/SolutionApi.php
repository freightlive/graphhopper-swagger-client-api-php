...
class SolutionApi
{
     ...
     * @return \GraphHopper\Model\Response
     */
     ...
     * @throws \GraphHopper\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GraphHopper\Model\Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSolutionWithHttpInfo($key, $job_id)
    {
        $returnType = '\GraphHopper\Model\Response';
