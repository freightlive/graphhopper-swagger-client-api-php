...
class Algorithm implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['problem_type'], $allowedValues)) {
        ...
        if (!in_array($this->container['objective'], $allowedValues)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getProblemTypeAllowableValues();
        if (!is_null($problem_type) && !in_array($problem_type, $allowedValues)) {
    ...
    {
        $allowedValues = $this->getObjectiveAllowableValues();
        if (!is_null($objective) && !in_array($objective, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'objective', must be one of '%s'",
                    implode("', '", $allowedValues)
